...
<?php echo form_open("sewa/save")?>
  ...
  <div class="form-group row">
    ...
    <div class="col-8">
      <select class="form-control" placeholder="Masukkan merk id" name="users_id" id="users_id">
  ...
  <div class="form-group row">
    ...
    <div class="col-8">
      <select class="form-control" placeholder="Masukkan merk id" name="mobil_id" id="mobil_id">
        <?php include "config.php"; 
