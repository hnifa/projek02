      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            ...
            ?>
              <li class="nav-item">
                <a href="<?php echo base_url("index.php/jsperawatan")?>" class="nav-link">
              ...
              <li class="nav-item">
                <a href="<?php echo base_url("index.php/perawatan")?>" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Perawatan</p>
                </a>
              </li>
              ...
              <li class="nav-item">
                <a href="<?php echo base_url("index.php/sewa")?>" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Sewa</p>
                </a>
              </li>
